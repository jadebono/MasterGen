...
// runs the phrase through the sha256 algorithm, returns a byte array.
function crunch(phra) {
  phra = sha256(phra, { asBytes: true });
  return phra;
}

// takes the byte array generated by crunch() and turns it into a hex string
